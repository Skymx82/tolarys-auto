      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-dark">
            Ou{' '}
            <Link href="/register" className="font-medium text-primary hover:text-opacity-90">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href="/forgot-password" className="font-medium text-primary hover:text-opacity-90">
                Mot de passe oublié ?
              </Link>
            </div>
          </div>
